...
- Hashline schema: `packages/coding-agent/src/edit/schemas.ts`
...
- Coding-agent execution/result shaping: `packages/coding-agent/src/edit/index.ts`
- Streaming preview strategy: `packages/coding-agent/src/edit/renderer.ts`
