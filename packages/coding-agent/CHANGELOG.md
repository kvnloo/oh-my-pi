...
- `omp worktree clear` no longer deletes a live task-isolation sandbox on macOS/BSD when the owning process and the clearer run under different locales ([{{detail_github_issue_ref}}]({{detail_github_issue_url}})).
