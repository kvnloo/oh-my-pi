...
- Fixed `read <image>?q=` and model role persistence misreading a thinking level embedded in a literal model id (e.g. `...:thinking:low`) as a user-selected reasoning effort.
